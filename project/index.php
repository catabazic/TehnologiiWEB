    ...
    <div class = "container">
        ...
        <main> 
            <div class = "container-main">
                <div class="image">
                    <img src="imagini/homepage_image.png" alt="Tea cup">
                </div>
                <div class="text">
                    <h1>GREEN</h1>
                    <h1><span class="tea">TEA</span> <span class="house">HOUSE</span></h1>
                    <p><span class="quote">"We are like tea, we don't know our own strength until we're in hot water"</span></p>
                    <p><span class="author">Sister Busche</span></p>
                </div>
            </div>
        </main>
    </div>
